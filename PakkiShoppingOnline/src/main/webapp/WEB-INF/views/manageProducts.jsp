...
<!-- to make use of spring form tag library -->
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<!--   with the help of spring this product is been link with the managementController  -->
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<!-- input element name would be changed from 'name' to ;path; -->
						...
						<div class="form-group">
							...
							<label class="control-label col-md-4" for="quanitity">Quantity
								Available: </label>

							<div class="col-md-8">

								<sf:input type="number" path="quanitity" id="quanitity"
									placeholder="Quanitity Available" class="form-control" />

							</div>

						</div>

						<!-- File elment for Image upload -->
